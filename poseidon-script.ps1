...
Set-DHCPServerv4Scope -ScopeID 192.168.101.0 -DNSDomain jdk0003.internal -DNSServer 192.168.101.4 -Router 192.168.101.1
...
New-WebVirtualDirectory -Site "Default Web Site" -Name Server -PhysicalPath C:\inetpub\wwwroot\serve
